...
def reccomendationNetwork(user_id, repull_data):
    ...
    repull_data = 1 to reputt the follower data, 0 if it already has been done (saves time)
    """
    #repull data?
    repull = repull_data
    if repull == 1:
        #find a user by username
        new_user = searchUser("https://soundcloud.com/" + str(user_id), True) #oliver-stahlmann-195515684
